          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right"> 
                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#network1" style="color:black;"> <i class="fa fa-wrench"></i><b style="font-zise:8px;"> Device Rusak : <?php 
                  ...
                  left join stock s on s.id_brng=k.id_brng where kategory_b in ('PC','UPS','Laptop','Operation') and status_m='Rusak'  ;");
                  ...
                  <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#network" style="color:black;"> <i class="fa fa-tags"> </i><b style="font-zise:10px;"> Device Waranty : <?php 
                   $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_service where kategori='Operation' ;");
                   echo mysqli_num_rows($jumlah_teknik);
                     ?></b></button>
            </ol>
          </div>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="card">
              <div class="card-body">
                <div class="chart" >
                  <div id="populasioperation1" style=" height: 600px;"></div>
                </div>
              </div>
              <!-- /.card-body -->
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="card">
              <div class="card-body">
                <div class="chart" >
                  <div id="piechartoperation" style=" height: 600px;"></div>
                </div>
              </div>
              <!-- /.card-body -->
            </div>
        ...
        <div class="modal-content">
          ...
          <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <?php
                                                    ...
                                                    left join tb_vendor v on v.id_vendor=s.id_vendor where kategori='Operation'
                                                ...
                                                <?php
                                                    $query3=mysqli_query($koneksi, "SELECT *
                                                      ...
                                                      left join tb_lokasi l on l.id_lokasi=s.id_lokasi
                                                       where status_m='Rusak'and kategory_b in ('PC','UPS','Laptop','Operation') and status_m='Rusak' order by id_masuk desc ;");
                                                    $no=0;
                                                    $no++;
                                                      while($row3=mysqli_fetch_array($query3)){
                                                        $idb=$row3['id_brng'];

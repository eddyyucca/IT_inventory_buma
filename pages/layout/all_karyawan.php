     ...
     <!-- SidebarSearch Form -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
                <a href="all_karyawan.php" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Table All Karyawan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-tools">
                      <a href="../prosess/excel/data_karyawan.php" class="btn btn-success "><i class="fa  fa-file-excel"></i>&nbsp;&nbsp;Export</a>
                      <a type="submit" class="btn btn-primary " data-toggle="modal" data-target="#myModal4"><i class="fa  fa-plus"></i>&nbsp;&nbsp;Add</a>
                      <!-- The Modal -->
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-header">
                      <h4 class="modal-title"><b>Form Add Karyawan</b></h4>
                    ...
                    <form method="post" enctype="multipart/form-data" action="#">
                      ...
                      <button type="submit" class="btn btn-primary pull-right pading" name="addkaryawan">Submit</button>
                      </div>
                    </form>
                    </div>
                  </div>
                ...
                <tr> 
                  ...
                  <td width='5%'>
                     <div class="tools" style="text-align: center;">
                       <a href="#" data-toggle="modal" data-target="#edit<?=$id_kar;?>"><i class="fa fa-edit" style="color: green;"></i></a> | 
                       <a href="#" data-toggle="modal" data-target="#deletekar<?=$id_kar;?>"><i class="fa fa-trash" style="color: red;"></i></a>
                    </div>
                  </td>
                </tr>

                  <!-- Modal Delete-->
                  <div class="modal fade" id="deletekar<?=$id_kar;?>" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <form  method="POST">
                          <div class="modal-body">
                            <p>  Apakah Anda yakin ingin menghapus Karyawan di bawah.? <br/> <b><?php echo $row['nik'] ?> | <?php echo $row['nama'] ?></p></b>
                          </div>
                          <input type="hidden" class="form-control" name="id_kar" value="<?=$id_kar;?>">
                          <div class="modal-footer">
                          <button type="submit" class="btn btn-danger" name="deletekar">delete</button>
                          </div>
                          </form >
                        </div>

      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="lva_operation.php" class="nav-link active">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Data LVA</p>
                    </a>
                  </li>
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
                <a href="../login/og_out.php" class="nav-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data Low Value Asset</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="col-12">
                ...
                <tr>
                 ...
                 <?php
                    ...
                    where kategory_b in ('PC','UPS','Laptop','Operation') and asset in ('Low Value Asset')  order by id desc ");
                    $no=0; 
                    $no++;
                                  ...
                                  <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-5">
                                        <div class="form-group">
                                          <label>No PO</label>
                                          <input type="text" class="form-control" name="sn" value="<?php echo $row['no_po_a'] ?>" disabled>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <div class="input-group-append"> 
                                           <button type="submit" class="btn btn-warning" name="updatebrnglva">Upload</button>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group">
                 ...
                 <div class="modal fade" id="delete<?=$ida;?>" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <form  method="POST">
                          <div class="modal-body">
                            <p>  Apakah Anda yakin ingin menghapus Data <b><?php echo $row['nama_pic'] ?>?</p></b>
                          </div>
                          ...
                          <input type="hidden" class="form-control" name="penerima" value="<?php echo $row3['nik'] ?>">
                          <div class="modal-footer">
                          <button type="submit" class="btn btn-danger" name="hapusdataassetoperation">delete</button>
                          </div>
                          </form >
                        </div>

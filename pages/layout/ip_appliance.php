        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">IP Appliance</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content" style="zoom:85%;">
        <div class="container-fluid">
            ...
            <div class="col-10">
              ...
              <?php
                  $query=mysqli_query($koneksi,"SELECT * FROM ip_address_2 s
                    left join tb_asset_network k on k.ip_address=s.ip_address_2 
              ...
              <td><?php echo $row['sn'] ?></td>
                <td><a href="#" class="small-box-footer" data-toggle="modal" data-target="#ip_address<?=$id_ip;?>"><?php echo $row['ip_address_2'] ?></a></td>
              ...
              <div class="col-2">
                ...
                <?php
                    $query=mysqli_query($koneksi,"SELECT * FROM ip_address_2 where status_='0' order by id_ip asc ");
                    $no=0;
                    $no++;
                      while($row=mysqli_fetch_array($query)){
                ?>
                ...
                <td width='5%'><?php echo $row['id_ip'] ?></td>
                  ...
                  <td><?php echo $row['ip_address_2'] ?></td>
                           ...
                           <h4 class="modal-title"><b> IP Address</b></h4>
                              ...
                              <div class="modal-body">
                                  <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                      <label>Note : Jika ingin merubah Lokasi bisa langsung ubah di bawah.</label>
                                      </div>
                                    <div class="form-group">
                                      <label>Lokasi</label>
                                      <select name="lokasi" class="form-control"  required>

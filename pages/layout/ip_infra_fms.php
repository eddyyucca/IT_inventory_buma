        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">IP Infra FMS</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content" style="zoom:85%;">
        <div class="container-fluid">
            ...
            <div class="col-10">
              ...
              <?php
                  $query=mysqli_query($koneksi,"SELECT * FROM ip_address_25 s
                    left join tb_asset_network k on k.ip_address=s.ip_address_25 
                    left join stock g on g.id_brng=k.id_brng 
                    left join tb_lokasi2 l on l.id_lok2=k.id_lok where s.status_='1' order by s.id asc ");
                  $no=0;
                  $no++; 
                    while($row=mysqli_fetch_array($query)){
                      $id_ip=$row['id'];
                      $ip=$row['ip_address_25'];
              ...
              <td><?php echo $row['sn'] ?></td>
                <td><a href="#" class="small-box-footer" data-toggle="modal" data-target="#ip_address<?=$id_ip;?>"><?php echo $row['ip_address_25'] ?></a></td>
                         ...
                         <h4 class="modal-title"><b> IP Address</b></h4>
                            ...
                            <div class="modal-body">
                                <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                  ...
                                  <div class="form-group">
                                    <label>Lokasi</label>
                                    <input type="text" class="form-control" name="ip" value="<?php echo $row['actual_location'] ?> <?php echo $row['detail_location'] ?>" disabled>
                                  </div>
              ...
              <div class="col-2">
                ...
                <?php
                    $query=mysqli_query($koneksi,"SELECT * FROM ip_address_25 where status_='0' order by id asc ");
                    $no=0;
                    $no++;
                      while($row=mysqli_fetch_array($query)){
                ?>
                ...
                <td width='5%'><?php echo $row['id'] ?></td>
                  ...
                  <td><?php echo $row['ip_address_25'] ?></td>

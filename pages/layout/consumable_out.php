        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="consumable_out.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                  <p>Consumable Out</p>
                </a>
              </li>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="btn-group">
                    <button type="button" class="btn btn-success"><i class="fa fa-file-excel"> Export</i></button>
                    <button type="button" class="btn btn-success btn-flat dropdown-toggle dropdown-icon" data-toggle="dropdown">
                    </button>
                      <div class="dropdown-menu" role="menu">
                        <a href="../prosess/excel/excel_barang_keluar_netwok.php" class="dropdown-item" type="submit" name="filter_tgl"><i class="fa  fa-file-excel-o"></i>&nbsp;&nbsp;Nerwork</a>
                        <a href="../prosess/excel/excel_barang_keluar_operation.php" class="dropdown-item" type="submit" name="filter_tgl"><i class="fa  fa-file-excel-o"></i>&nbsp;&nbsp;Operation</a>
                        <a href="../prosess/excel/excel_barang_keluar_radio.php" class="dropdown-item" type="submit" name="filter_tgl"><i class="fa  fa-file-excel-o"></i>&nbsp;&nbsp;Radio</a>
                      </div>
                  </div>
                  </div>
                  <!-- /.card-header -->
                ...
                <tr>
                  ...
                  <th>Aksi</th>
                    ...
                    FROM tb_keluar k
                    join stock s on s.id_brng=k.id_brng_k
                    order by id_keluar desc  ") or die($koneksi->error); 
                     $no=0;
                     $no++;
                ...
                <tr>
                  ...
                  <td width='5%'>
                     ...
                     <a href="#" data-toggle="modal" data-target="#edit<?=$idk;?>"><i class="fa fa-edit" style="color: green;"></i></a>
                    <a href="#" data-toggle="modal" data-target="#delete<?=$idk;?>"><i class="fa fa-trash" style="color: red;"></i></a>
                    </div>
                  </td>
                </tr>
                <!-- Modal edit-->
                <div class="modal fade" id="edit<?=$idk;?>" role="dialog">
                              ...
                              <div class="modal-body">
                                  <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                      <label>No PO</label>
                                      <input type="text" class="form-control" name="no_po_k" value="<?=$no_po_k;?>">
                                    </div>
                                    <div class="form-group">
                                      <label>Stock</label>
                                      <input type="number" class="form-control" name="qty_k" value="<?=$qty_k;?>">
                                    </div>
                                    <div class="form-group">
                                      <label>Ket</label>
                                      <input type="text" class="form-control" name="deskripsi1" value="<?=$deskripsi1;?>">
                                    </div>
                                    <div class="form-group">
                                      <label>Keterangan</label>
                                      <input type="text" class="form-control" name="tanggal" value="<?php echo $row['tanggal_k'] ?>" disabled>
                                    </div>
                                    <input type="hidden" name="idb" value="<?=$idb;?>">
                                    <input type="hidden" name="idk" value="<?=$idk;?>">
                                    <div class="modal-footer">
                                    <button type="submit" class="btn btn-warning" name="updatebrngkeluar">Update</button>
                 ...
                 <!-- Modal Delete-->
                 <div class="modal fade" id="delete<?=$idk;?>" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <form  method="POST">
                          <div class="modal-body">
                            <p>  Apakah Anda yakin ingin menghapus Barang di bawah ? <br><b><?php echo $row['nma_brng'] ?>, Qty : <?=$qty_k;?></p></b>
                          </div>
                          <input type="hidden" class="form-control" name="qty_k" value="<?=$qty_k;?>">

            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="lva_network.php" class="nav-link active">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Data LVA</p>
                    </a>
                  </li>
              ...
              <div class="col-12">
                ...
                <tr>
                 ...
                 <?php
                    ...
                    left join tb_lokasi2 l on l.id_lok2=n.id_lok where s.asset='Low Value Asset' order by id desc  ");
                    $no=0;
                    $no++;
                ...
                <tr>
                  ...
                  <td style="text-align: center;" width='2%'><a href="#" data-toggle="modal" data-target="#myModal1<?=$idn;?>">
                          <i class="fa fa-upload"></i>
                    </a>
                  </td>
                  <td><?php echo $row['update_at2'] ?></td>
                  <td width='5%'>
                     <div class="tools" style="text-align: center;">
                     <a href="#" data-toggle="modal" data-target="#edit<?=$idn;?>"><i class="fa fa-eye" style="color: green;"></i></a> 
                              ...
                              <div class="modal-body">
                                  <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="additional_asset_description" value="<?php echo $row['ip_address'] ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                      <label>S/N</label>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="#" value="<?php echo $row['lokasi'] ?> <?php echo $row['detail_location'] ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-warning" name="updatebrnglvanetwork">Update</button>
                 ...
                 <div class="modal fade" id="delete<?=$idn;?>" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                          <button type="submit" class="btn btn-danger" name="deletebrngassetnetwork1">delete</button>
                          </div>
                          </form > 
                        </div>
                      </div>
                    ...
                    <div class="modal fade" id="myModal1<?=$idn;?>" role="dialog">
                            <div class="modal-dialog modal-lg">
                              <div class="box ">
                                <div class="modal-header">
                                  <img src="../../logo.jpg" class="pull-right" style="height:38px; width:95px;">
                                <h4 class="modal-title"> Upload File Config Untuk <b> <?php echo $row['nma_brng'] ?> / <?php echo $row['ip_address'] ?></b> | Last Update : 15-11-2022 </h4>
                                </div>
                                <div class="modal-body">

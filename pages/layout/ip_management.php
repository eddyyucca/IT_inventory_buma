            ...
            <div class="col-10">
                <div class="card">
                  ...
                  ?></b> 
                   ...
                   <a href="../prosess/excel/ip_management0.php" class="btn btn-success pull-right "><i class="fa  fa-file-excel"></i>&nbsp;&nbsp;Export</a>
                  </div>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                            ...
                            <div class="modal-body">
                                ...
                                <!--   <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <button type="submit" class="btn btn-warning pull-right pading" name="update3">Pindah Vlan/400</button>
              ...
              <div class="col-2">
                ...
                <?php
                    $query=mysqli_query($koneksi,"SELECT * FROM ip_address_0 where status_='0' and id_ip > '0' and id_ip < '30' order by id_ip asc ");
                    $no=0;
                    $no++;
                      while($row=mysqli_fetch_array($query)){
                        $ip=$row['id_ip'];

            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="btn-group">
                    <a href="#" class="btn btn-primary" type="submit" name="filter_tgl"><i class="fa  fa-plus"></i>&nbsp;&nbsp;Add</a> 
                  </div>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                ...
                <tr>
                  ...
                  <td><span class="badge bg-danger"><?php echo$row['nama']; ?></span></td>
                  <td><?php echo$row['lokasi']; ?></td>
                  <td><?php echo$row['last_inspeksi']; ?></td>
                  <td> <span class="badge bg-danger">
                      <?php  $create = new DateTime($row['last_inspeksi']);
																							$today =new DateTime();
																							$diff = $today->diff($create);
																							echo $diff->d; echo " Day ago";?>
                          </smpan></td>
                  <td ><?php echo$row['note_']; ?></td>
                  <td width='15%'><div class="tools" style="text-align: center;">
                     <a href="#" data-toggle="modal" data-target="#edit<?=$idn;?>"><i class="fa fa-list-alt" style="color: green;"></i></a>
                    </div></td>
                  <td width='5%'>

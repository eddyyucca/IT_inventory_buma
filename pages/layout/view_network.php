...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" action="view_network.php" method="get">
  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="zoom:85%">
        ...
        <div class="row  mb-2">
          <div class="col-sm-12">
                <a href="view_network_cons.php" class="btn btn-primary btn-sm" style="color:black;"> <i class="fa fa-book"  style="color:white;"></i><b style="font-zise:8px; color:white;"> Consumable</b></a>
          </div>
        </div>
        <?php  
          ...
          ?>
            ...
            if(isset($_GET['cari'])){
              $cari = $_GET['cari'];
              $query=mysqli_query($koneksi, "SELECT  * FROM stock s left join tb_lokasi l on l.id_lokasi=s.id_lokasi where asset in ('Asset','Low Value asset') and kategory_b in ('Network','Radio Wireless','Switch','cctv') and nma_brng like '%".$cari."%'");		
            }else{
              $query=mysqli_query($koneksi, "SELECT  * FROM stock s left join tb_lokasi l on l.id_lokasi=s.id_lokasi where asset in ('Asset','Low Value asset') and kategory_b in ('Network','Radio Wireless','Switch','cctv') order by kategory_b DESC ");	
            }
           ...
           ?>
              <div class="col-md-2 col-sm-2">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body"> 
                        <b style="color:#a6a6a6;"><?php echo$row['no_po']; ?></b>
                          <h4 class="card-title float-right"><a href="network_actv.php?id=<?=$idb;?>"  style="color:#2E9E0B;"><i class="fa  fa-tasks"></i></a></b></h4><br>
                          ...
                          <ul class="list-group list-group-unbordered"> 
                            ...
                            <li class="list-group-item">
                            <a href="network_actv.php?id=<?=$idb;?>" style="color:#008ECC;"><B>Active</B><b class="float-right"><?php echo $row['device_active'] ?></b>
                            </a> 
                            </li>
                        </ul><BR>
                          <a href="#" class="btn btn-primary " data-toggle="modal" data-target="#add<?=$idb;?>"><i class="fa  fa-plus"></i></a>
                          <a href="table.php?id=<?=$idb;?>" class="btn btn-warning"><i class="fa  fa-book"></i> Ready</a>

        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">IP Unit FMS</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content" style="zoom:85%;">
        <div class="container-fluid">
            ...
            <div class="col-10">
              ...
              <?php
                  $query=mysqli_query($koneksi,"SELECT * FROM ip_address_20 s
                    left join tb_asset_network k on k.ip_address=s.ip_address_20 
                    left join stock g on g.id_brng=k.id_brng where s.status_='1' order by s.id_ip asc ");
                  $no=0;
                  $no++; 
                    while($row=mysqli_fetch_array($query)){
                      $id_ip=$row['id_ip'];
                      $ip=$row['ip_address_20'];
              ...
              <tr>
               <td width='5%'><?php echo $no; ?></td>
                  <td > <b><?php echo $row['hostname'] ?></b></td>
                <td><?php echo $row['type_unit'] ?></td>
                <td><a href="#" class="small-box-footer" data-toggle="modal" data-target="#ip_address<?=$id_ip;?>"><?php echo $row['ip_address_20'] ?></a></td>
                <td><?php echo $row['sn_disply'] ?></td>
                <td><?php echo $row['sn_core'] ?></td>
                <td><?php echo $row['ket_20'] ?></td>
              </tr>
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        <div class="modal-header">
                         <h4 class="modal-title"><b><?=$hostname;?> - <?php echo $row['type_unit'] ?> </b></h4>
                            ...
                            <div class="modal-body">
                                <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="ip" value="<?=$ip;?>">
                                  </div>
                                  <div class="form-group">
                                    <label>Unit</label>
                                    <input type="text" class="form-control" name="asset_descrip" value="<?=$hostname;?> - <?php echo $row['type_unit'] ?> " disabled>
                                  </div>
                                  <div class="form-group">
                                    <label>S/N Disply</label>
                                    <input type="text" class="form-control" name="sn_disply" value="<?php echo $row['sn_disply'] ?> " >
                                  </div>
                                  <div class="form-group">
                                    <label>S/N Core</label>
                                    <input type="text" class="form-control" name="sn_core" value="<?php echo $row['sn_core'] ?>" >
                                  </div>
                                  <div class="form-group">
                                    <label>Ket :</label> 
                                    <textarea class="form-control" rows="3  " name="ket" placeholder="Ket"><?php echo $row['ket_20'] ?></textarea>
                                  </div>
                                  <input type="hidden" name="idm" value="<?=$id_ip;?>">
                                  <div class="modal-footer">
                                    <button type="submit" class="btn btn-danger pull-right pading" name="updateip_20" onclick="return confirm('Anda Yakin, ingin menghapus Ip <?=$ip;?>, Ip akan masuk ke list Ip Free jika di hapus')"><i class="fa fa-trash" style="color: white;"></i></button>
                                    <button type="submit" class="btn btn-success pull-right pading" name="updateip1_20">Update</button>
              ...
              <div class="col-2">
                ...
                <?php
                    $query=mysqli_query($koneksi,"SELECT * FROM ip_address_20 where status_='0' order by id_ip asc ");
                    $no=0;
                    $no++;
                      while($row=mysqli_fetch_array($query)){
                        $id_ip1=$row['id_ip'];
                        $ip1=$row['ip_address_20'];
                ?>
             
                <tr>
                <td width='5%'><?php echo $row['id_ip'] ?></td>
              
                  <td><a href="#" class="small-box-footer" data-toggle="modal" data-target="#unit<?=$id_ip1;?>"><?php echo $row['ip_address_20'] ?></a></td>
               
                </tr>
                <div class="modal fade" id="unit<?=$id_ip1;?>" role="dialog">
                      <div class="modal-dialog">
                              ...
                              <div class="modal-body">
                                  <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="hidden" class="form-control" name="ip" value="<?=$ip1;?>">
                                    </div>
                                    <div class="form-group">
                                      <label>Unit</label>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select name="type" class="form-control"  required>
                                        <option>-</option>
                                        <option>CAT 777E</option>
                                        <option>KOMATSU 785</option>
                                      </select>
                                    </div> 
                                    <div class="form-group">
                                    <label>S/N Disply</label>
                                    <input type="text" class="form-control" name="sn_disply" >
                                  </div>
                                  <div class="form-group">
                                    <label>S/N Core</label>
                                    <input type="text" class="form-control" name="sn_core" >
                                  </div>
                                    <div class="form-group">
                                      <label>Ket :</label>
                                    ...
                                    <div class="form-group">
                                      <text style="color:green;"><b>Saya dan Anda Selamat setiap hari ;)</b></text>
                                    </div>
                                    <input type="hidden" name="idm" value="<?=$id_ip;?>">
                                    <div class="modal-footer"> 
                                      <button type="submit" class="btn btn-primary pull-right pading" name="updateip20">Submit</button>

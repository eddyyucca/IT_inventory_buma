        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="history_operation.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Operation</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#">History Data</a></li>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <tr>
                 ...
                 <?php
                    $query=mysqli_query($koneksi, "SELECT *
                     FROM tb_history_operation h 
                    left join stock s on s.id_brng=h.id_brng
                    left join tb_karyawan k on k.nik=h.id_kar where kategori='Operation' order by id desc   ");
                    $no=0;
                    $no++;
                ...
                <tr>
                  ...
                  <td  width='8%'><?php echo $row['no_urut'] ?><?php echo $row['id'] ?></td>
                  <td><?php echo $row['nama'] ?></td>
                  <td><?php echo $row['nik'] ?></td>
                  <td><?php echo $row['section'] ?></td>
                  <td><?php echo $row['nma_brng'] ?></td> 
                  <td><?php echo $row['sn_s'] ?></td>
                  <td><?php echo $row['no_asset_r'] ?>
                </td>
                  <td width='5%'>
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" role="menu">
                      <a class="dropdown-item" href="../prosess/form_pengembalian.php?id=<?=$ida;?>">Form pengembalian</a>
                      <a class="dropdown-item" href="../prosess/form_bak.php?id=<?=$ida;?>" target="_blank">Form Berita Acara Kerusakn</a>
                    </div>
                  </div>
                  </td>

     ...
     <!-- SidebarSearch Form -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="asset_operation.php" class="nav-link active">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Data Asset</p>
                    </a>
                  </li>
          ...
          <li class="nav-item">
                <a href="tall_karyawan.php" class="nav-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="view_operation.php">View Operation</a></li>
              <li class="breadcrumb-item active">Device Active</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="btn-group">
                    <a href="#" class="btn btn-success" type="submit" name="filter_tgl"><i class="fa  fa-file-excel"></i>&nbsp;&nbsp;Export</a> 
                  </div> 
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                ...
                <tr>
                 ...
                 <?php
                    ...
                    left join tb_karyawan k on k.nik=a.id_kar
                    where kategory_b in ('PC','UPS','Laptop','Operation') and asset in ('Asset', 'Low Value Asset') and s.id_brng='$idba'  order by id desc ");
                    $no=0; 
                    $no++;
                ...
                <tr>
                  ...
                  <td><?php echo $row['no_urut'] ?><?php echo $row['id'] ?></td>
                  ...
                  <td><?php echo $row['create_at1'] ?></td>
                  <td width='6%'>
                     <div class="tools" style="text-align: center;">
                     <a href="../prosess/serah_terima.php?id=<?=$ida;?>" target="_blank"><i class="fa fa-print" style="color:black;"> </i></a>
                    </div>
                  </td>
                  <td width='5%'>
                     <div class="tools" style="text-align: center;">
                     <a href="#" data-toggle="modal" data-target="#edit<?=$ida;?>"><i class="fa fa-edit" style="color: green;"></i></a>  
                     <a href="#" data-toggle="modal" data-target="#delete<?=$ida;?>"><i class="fa fa-trash" style="color: red;"></i></a>
                    </div>
                  </td>
                </tr>

                <!-- Modal Delete-->
                <div class="modal fade" id="edit<?=$ida;?>" role="dialog">
                                    ...
                                    <div class="row">
                                      <div class="col-3">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="nama_pic" value="<?php echo $row['nama'] ?>"  disabled>
                                        </div>
                                      </div>
                                      <div class="col-4">
                                        <div class="form-group">
                                      ...
                                      <div class="col-5">
                                        <div class="form-group">
                                          <label>Section</label>
                                          <input type="text" class="form-control" name="section" value="<?php echo $row['section'] ?>" disabled>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-3">
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" name="nma_brng" value="<?php echo $row['nma_brng'] ?>" disabled>
                                        </div>
                                      </div>
                                      <div class="col-4">
                                        <div class="form-group">
                                          <label>S/N</label>
                                          <input type="text" class="form-control" name="no_po_a" value="<?php echo $row['sn'] ?>" disabled>
                                        </div> 
                                      </div>
                                      <div class="col-5">
                                        <div class="form-group">
                                          <label>No Asset</label>
                                          <input type="text" class="form-control" name="sn" value="<?php echo $row['no_asset'] ?>" disabled>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group">
                                      <label>Lokasi</label>
                                      <input type="text" class="form-control" name="lokasi" value="<?php echo $row['lokasi'] ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                      <label for="exampleInputFile">Upload Scanan Tanda Terima :</label>
                                      <div class="input-group">
                                        <div class="custom-file">
                                          <input type="file" name="doc" class="custom-file-input" id="exampleInputFile" required>
                                          <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                                        </div>
                                        <div class="input-group-append"> 
                                           <button type="submit" class="btn btn-warning" name="updatebrngasset">Upload</button>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="form-group">
                                    <label>Scanan Tanda terima :</label>
                                      <center><img class="card-img-top" src=" ../uploads/file_TT/<?php echo $row['doc'] ?>" alt="Card image"  style="width:100%; "></center>
                                    </div>
                 ...
                 <!-- Modal Delete-->
                 <div class="modal fade" id="delete<?=$ida;?>" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <form  method="POST">
                          <div class="modal-body">
                            <p> Anda yakin A/n <b><?php echo $row['nama'] ?></b> telah mengembalikan barang.?</p>
                            <input type="text" class="form-control" name="ket" placeholder="Ket Pengembalian..." required>
                          </div>
                          <input type="hidden" class="form-control" name="idb" value="<?=$idb;?>">
                          <input type="hidden" class="form-control" name="ida" value="<?=$ida;?>">
                          <input type="hidden" class="form-control" name="nama_pic" value="<?=$nama_pic;?>">
                          <input type="hidden" class="form-control" name="nik" value="<?=$nik;?>">
                          <input type="hidden" class="form-control" name="section" value="<?=$section;?>">
                          <input type="hidden" class="form-control" name="sn" value="<?=$sn;?>">
                          <input type="hidden" class="form-control" name="no_asset" value="<?=$no_asset;?>">
                          <input type="hidden" name="penerima" value="<?php echo $row3['nama'] ?>/<?php echo $row3['nik'] ?>">
                          <div class="modal-footer">
                          <button type="submit" class="btn btn-warning" name="hapusdataassetoperation">Ok</button>
                          </div>
                          </form >
                        </div>

...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="history_network.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Network</p>
                </a>
              </li>
  ...
  <div class="content-wrapper" style="zoom:85%;">
              ...
              <div class="col-12">
                ...
                <th>No</th>
                 ...
                 <?php
                    ...
                    FROM tb_history_data h 
                    left join stock s on s.id_brng=h.id_brng where kategori='Network' order by id desc  ");
                    $no=0;
                    $no++;
                ...
                <tr>
                  ...
                  <td><?php echo $row['ip_address_h'] ?></td>

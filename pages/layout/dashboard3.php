          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right"> 
                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#network1" style="color:black;"> <i class="fa fa-wrench"></i><b style="font-zise:8px;"> Device Rusak : <?php 
                  ...
                  left join stock s on s.id_brng=k.id_brng where kategory_b in ('Radio Rig','Radio','Radio HT') and status_m='Rusak'  ;");
                  ...
                  <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#network" style="color:black;"> <i class="fa fa-tags"> </i><b style="font-zise:10px;"> Device Waranty : <?php 
                    $jumlah_teknik = mysqli_query($koneksi,"SELECT * FROM tb_service where kategori='Radio' ;");
                    echo mysqli_num_rows($jumlah_teknik);
                    ?></b></button>
            </ol>
          </div>
        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <div class="card">
              <div class="card-body">
                <div class="chart" >
                  <div id="populasiradio" style=" height: 600px;"></div>
                </div>
              </div>
              <!-- /.card-body -->
            </div>
          ...
          <div class="col-md-5">
            ...
            <div class="card">
              <div class="card-body">
                <div class="chart" >
                  <div id="piechart1" style=" height: 600px;"></div>
                </div>
              </div>
              <!-- /.card-body -->
            </div>

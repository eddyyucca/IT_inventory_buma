...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" action="view_operation.php" method="get">
  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="zoom:85%;">
        ...
        <div class="row  mb-2">
          <div class="col-sm-12">
                <a href="view_operation_cons.php" class="btn btn-primary btn-sm" style="color:black;"> <i class="fa fa-book"  style="color:white;"></i><b style="font-zise:8px; color:white;"> Consumable</b></a>
          </div>
        </div>
        <?php  
            ...
            <?php
               if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $query=mysqli_query($koneksi, "SELECT  * FROM stock s left join tb_lokasi l on l.id_lokasi=s.id_lokasi where kategory_b in ('PC','UPS','Laptop','Operation') and asset in ('Asset','Low Value Asset') and nma_brng like '%".$cari."%'");		
              }else{
                $query=mysqli_query($koneksi, "SELECT  * FROM stock s left join tb_lokasi l on l.id_lokasi=s.id_lokasi where kategory_b in ('PC','UPS','Laptop','Operation') and asset in ('Asset','Low Value Asset') order by id_brng DESC  ");
              }
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                            <a href="operation_actv.php?id=<?=$idb;?>" style="color:#008ECC;"><B>Active</B><b class="float-right"><?php echo $row['device_active'] ?></b>
                            </a>
                            </li>
                        </ul><BR>
                          <a href="#" class="btn btn-primary " data-toggle="modal" data-target="#add<?=$idb;?>"><i class="fa  fa-plus"></i></a>
                          <a href="table1.php?id=<?=$idb;?>" class="btn btn-warning"><i class="fa  fa-book"></i> Ready</a>

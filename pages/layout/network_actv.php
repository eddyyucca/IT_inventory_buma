        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item" ><a href="view_network.php" >View Network</a></li>
              ...
              <div class="col-12">
                ...
                <tr>
                 ...
                 $idba= mysqli_real_escape_string($koneksi,$_GET['id']);
                    ...
                    left join tb_lokasi2 l on l.id_lok2=n.id_lok where asset in ('Asset','Low Value Asset') and s.id_brng='$idba' order by id desc  ");
                    $no=0;
                    $no++;
                ...
                <tr>
                  ...
                  <td><a href="../uploads/Network/<?php echo $row['foto_perangkat'] ?>" target="_blank"> <?php echo $row['asset_hana'] ?></a></td>
                  <td><?php echo $row['nma_brng'] ?></td>
                  <td><b><?php echo $row['asset'] ?></b></td>
                  ...
                  <td width='9%'><?php echo $row['update_at2'] ?></td>
                  <td width='5%'>
                 ...
                 <div class="modal fade" id="delete<?=$idn;?>" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                          <button type="submit" class="btn btn-danger" name="deletebrngassetnetwork2">delete</button>
                          </div>
                          </form >
                        </div>
                      </div>

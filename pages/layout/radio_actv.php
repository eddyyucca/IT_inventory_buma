...
// cek apakah yang mengakses halaman ini sudah login
  ...
  FROM tb_user where nik='$g'   ");
   ...
   left join stock s on s.id_brng=a.id_brng where asset in ('Asset', 'Low Value Asset') and s.id_brng='$idba' 
    order by id desc  ");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo $row2['nma_brng'] ?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="view_radio.php">View Radio</a></li>
                           ...
                           <h4 class="modal-title"><b> Form Edit</b></h4>
                              ...
                              <div class="modal-body">
                                  <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <button type="submit" class="btn btn-warning pull-right pading" name="updateassetradio">Update</button>
                 ...
                 <div class="modal fade" id="delete<?=$id;?>" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                          <a type="button" class="btn btn-default pull-right pading" data-dismiss="modal">Cancel</a>
                          <button type="submit" class="btn btn-danger" name="hapusdatalvaradio">delete</button>
                          </div>
                          </form >
                        </div>
                          ...
                          <div class="modal fade" id="myModal1<?=$id;?>" role="dialog">
                            <div class="modal-dialog modal-lg">
                              <div class="box ">
                                <div class="modal-header">
                                  <img src="../../logo.jpg" class="pull-right" style="height:38px; width:95px;">
                                <h4 class="modal-title"> Upload File Master Untuk <b> <?=$unit;?></b> | Last Update : 15-11-2022 </h4>
                                </div>
                                <div class="modal-body">

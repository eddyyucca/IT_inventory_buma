          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="asset_radio.php" class="nav-link active">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Data Asset</p>
                    </a>
                  </li>
              ...
              <div class="col-12">
                ...
                <tr>
                 ...
                 <?php
                    ...
                    FROM tb_asset_radio a
                    left join stock s on s.id_brng=a.id_brng where asset='Asset'
                       order by id desc  ");
                    $no=0;
                    $no++;
                ...
                <tr>
                  ...
                  <td style="text-align: center;" width='2%'><a href="#" data-toggle="modal" data-target="#myModal1<?=$id;?>">
                     <i class="fa fa-upload"></i>
                    </a>
                  </td>
                  <td><?php echo $row['data_modified'] ?></td>
                  <td width='5%'>
                     <div class="tools" style="text-align: center;">
                     <a href="#" data-toggle="modal" data-target="#edit<?=$id;?>"><i class="fa fa-edit" style="color: green;"></i></a> |
                     <a href="#" data-toggle="modal" data-target="#delete<?=$id;?>"><i class="fa fa-trash" style="color: red;"></i></a>
                    </div>
                  </td>
                </tr>
                              ...
                              <div class="modal-body">
                                  <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                      <label>Unit</label>
                                      <input type="text" class="form-control" name="unit" value="<?php echo $row['unit'] ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                      <label>Type Unit</label>
                                      <input type="text" class="form-control" name="type_unit" value="<?php echo $row['type_unit'] ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                      <label>Kategori</label>
                                      <input type="text" class="form-control" name="Kategori" value="<?php echo $row['kategori'] ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="lokasi" value="<?php echo $row['data_modified'] ?>" disabled>
                                    </div>
                                    <input type="hidden" name="idr" value="<?=$id;?>">
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                      <button type="submit" class="btn btn-warning" name="updateassetradio">Update</button>
                                    </div>
                                  </form>
                              </div>
                        </div>
                 ...
                 <div class="modal fade" id="delete<?=$id;?>" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <form  method="POST">
                          <div class="modal-body">
                            <p>  Apakah Anda yakin ingin menghapus Data ini.??<br> <b><?php echo $row['unit'] ?></p></b>
                          </div>
                          <input type="hidden" class="form-control" name="idb" value="<?=$idb;?>">
                          <input type="hidden" class="form-control" name="idr" value="<?=$id;?>">
                          <input type="hidden" class="form-control" name="unit" value="<?=$unit;?>">
                          <input type="hidden" class="form-control" name="SN" value="<?=$SN;?>">
                          <input type="hidden" class="form-control" name="nma_brng" value="<?=$nma_brng;?>">
                          <input type="hidden" class="form-control" name="type_unit" value="<?=$type_unit;?>">
                          <input type="hidden" class="form-control" name="no_asset" value="<?=$no_asset;?>">
                          <div class="modal-footer">
                          <button type="submit" class="btn btn-danger" name="hapusdataassetradio">delete</button>
                          </div>
                          </form >
                        </div>
                      </div>
                    ...
                    <!-- The Modal -->
                    <div class="modal fade" id="myModal1<?=$id;?>">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">

                          <!-- Modal Header -->
                          <div class="modal-header">
                          <h5 class="modal-title"> Upload File Master Untuk <b> <?=$unit;?></b> | Last Update : 15-11-2022 </h5>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="input-group">
                                        ...
                                        <div class="input-group-append"> 
                                          <button class="btn btn-primary pull-right" type="submit" name="updatemasterradio">Upload</button>
                                        </div>
                                    </div>
                                    <br>

            ...
            <div class="col-10">
                <div class="card">
                  ...
                  ?></b> 
                   ...
                   <a href="../prosess/excel/ip_management40.php" class="btn btn-success pull-right "><i class="fa  fa-file-excel"></i>&nbsp;&nbsp;Export</a>
                  </div> 
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
              ...
              <div class="col-2">
                ...
                <?php
                    $query=mysqli_query($koneksi,"SELECT * FROM ip_address_40 where status_='0' and id_ip > '0' and id_ip < '30' order by id_ip asc ");
                    $no=0;
                    $no++;
                      while($row=mysqli_fetch_array($query)){
                        $ip=$row['id_ip'];
                ...
                <td width='5%'><?php echo $row['id_ip'] ?></td>
                  ...
                  <td><?php echo $row['ip_address_40'] ?></td>
              ...
              <table id="example2" class="table table-bordered table-hover ">
                ...
                <?php
                    $query=mysqli_query($koneksi,"SELECT * FROM ip_address_40 where status_='0' and id_ip > '31' and id_ip < '255' order by id_ip asc ");
                    $no=0;
                    $no++;
                      while($row=mysqli_fetch_array($query)){
                        $ip=$row['id_ip'];

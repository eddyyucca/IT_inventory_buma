        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">IP Server</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content" style="zoom:85%;">
        <div class="container-fluid">
            ...
            <div class="col-10">
              ...
              <?php
                  $query=mysqli_query($koneksi,"SELECT * FROM ip_address_17 s
                    left join tb_asset_network k on k.ip_address=s.ip_address_17 
                    left join stock g on g.id_brng=k.id_brng where s.status_='1' order by s.id_ip asc ");
                  $no=0;
                  $no++;
                    while($row=mysqli_fetch_array($query)){
                      $id_ip=$row['id_ip'];
                      $ip=$row['ip_address_17'];
              ...
              <td><?php echo $row['sn'] ?></td>
                <td><a href="#" class="small-box-footer" data-toggle="modal" data-target="#ip_address<?=$id_ip;?>"><?php echo $row['ip_address_17'] ?></a></td>
                        ...
                        <img src="../../logo.jpg" class="pull-right" style="height:38px; width:95px;">
                         <h4 class="modal-title"><b> IP Address</b></h4>
                            ...
                            <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                  ...
                                  <div class="form-group">
                                    <label>Ket :</label>
                                    <textarea class="form-control" rows="3  " name="ket" placeholder="Ket" disabled><?php echo $row['ket'] ?></textarea>
                                  </div>
                                  <div class="form-group">
                                    <label>Lokasi Actual</label>
                                    <input type="text" class="form-control" name="ip" value="<?php echo $row['lokasi'] ?> <?php echo $row['detail_location'] ?>" disabled>
                                  </div>
                                <!--   <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="modal-footer">
                                    <button type="submit" class="btn btn-success pull-right pading" name="update2">Update</button>
              ...
              <div class="col-2">
                ...
                <?php
                    $query=mysqli_query($koneksi,"SELECT * FROM ip_address_17 where status_='0' order by id_ip asc ");
                    $no=0;
                    $no++;
                      while($row=mysqli_fetch_array($query)){
                ?>
                ...
                <td width='5%'><?php echo $row['id_ip'] ?></td>
                  ...
                  <td><?php echo $row['ip_address_17'] ?></td>
                           ...
                           <h4 class="modal-title"><b> IP Address</b></h4>
                              ...
                              <div class="modal-body">
                                  <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                      <label>Hostname</label>
                                      <input type="text" class="form-control" name="asset_descrip" value="<?=$hostname;?><?php echo $row['asset_description'] ?> ">
                                    </div>
                                    <div class="form-group">
                                      <label>Ket :</label>
                                    ...
                                    <div class="form-group">
                                      <label>Lokasi Actual</label>
                                      <input type="text" class="form-control" name="ip" value="<?php echo $row['lokasi'] ?> <?php echo $row['actual_location'] ?> <?php echo $row['detail_location'] ?>" disabled>
                                    </div>
                                    <div class="form-group">
                                      <label>Note : Jika ingin merubah Lokasi bisa langsung di ubah bawah.</label>
                                      </div>
                                    <div class="form-group">
                                      <label>Lokasi</label>
                                      <select name="lokasi" class="form-control"  required>
                                    ...
                                    <div class="modal-footer">
                                      <button type="submit" class="btn btn-primary pull-right pading" name="insertketableassesstnetwork">Submit</button>

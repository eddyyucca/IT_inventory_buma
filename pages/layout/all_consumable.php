        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="all_consumable.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Consumable In</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Consumable In</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <div class="btn-group">
                       <a href="../prosess/excel/excel_barang_consumable.php" class="btn btn-success" type="submit" name="filter_tgl"><i class="fa  fa-file-excel"></i>&nbsp;&nbsp;Export</a>
                    </div> 
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                ...
                <tr>
                  ...
                  <th>Aksi</th>
                    ...
                    left join tb_lokasi l on l.id_lokasi=s.id_lokasi where asset='Consumable' order by id_masuk desc ");
                    $no=0; 
                    $no++;
                ...
                <tr>
                  ...
                  <td width='8%'>
                     ...
                     <?php if($row['qr_code'] = $row['qr_code']){ ?>
                       <a href="#" data-toggle="modal" data-target="#view<?=$idb;?>"><i class="fa fa-qrcode" style="color:black;"></i></a>
                       <?php  }elseif($row['qr_code'] = 1) {  ?>
                        <i class="fa fa-qrcode" style="color:red;"></i>
                        <?php } ?>
                    </div>
                  </td>
                           ...
                           <h4 class="modal-title"><b> Form Edit</b></h4>
                              ...
                              <div class="modal-body">
                                  <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <button type="submit" class="btn btn-warning pull-right" name="updatebrngmasuk">Update</button>
                                    </div>
                                  </form>
                              </div>

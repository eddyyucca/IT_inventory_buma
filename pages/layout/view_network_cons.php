...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" action="view_network_cons.php" method="get">
  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="zoom:85%">
        ...
        <div class="row  mb-2">
          <div class="col-sm-12">
                <a href="view_network.php" class="btn btn-primary btn-sm" style="color:black;"> <i class="fa fa-book"  style="color:white;"></i><b style="font-zise:8px; color:white;"> Device</b></a>
          </div>
        </div>
        <?php  
          ...
          ?>
            <div class="row">
               ...
               if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $query=mysqli_query($koneksi, "SELECT  * FROM stock s left join tb_lokasi l on l.id_lokasi=s.id_lokasi where asset in('Consumable') and kategory_b in ('Network','Radio Wireless','Switch','cctv','POE') and nma_brng like '%".$cari."%'");		
              }else{
                  $query=mysqli_query($koneksi, "SELECT  * FROM stock s left join tb_lokasi l on l.id_lokasi=s.id_lokasi where asset in('Consumable') and kategory_b in ('Network','Radio Wireless','Switch','cctv','POE') order by kategory_b DESC");
              }
               ...
               <div class="col-md-2">
                    ...
                    <div class="card">
                       ...
                       <center><b style="color:#a6a6a6;">Part Number : <?php echo$row['part_number']; ?></b></center>
                        <div class="card-body">
                        <h4 class="card-title float-right"><a href="table3.php?id=<?=$idb;?>"  style="color:#2E9E0B;"><i class="fa  fa-list"></i></a>  <a href="table4.php?id=<?=$idb;?>"  style="color:#2E9E0B;"><i class="fa  fa-book"></i></a></b></h4><br>
                         <h4 class="card-title"><b><center><?php echo substr($row['nma_brng'], 0, 25) ?></b></center></h4>
                         ...
                         <ul class="list-group list-group-unbordered">
                          ...
                          <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#cekout<?=$idb;?>"><i class="fa  fa-share-square"></i> Get</a>
                ...
                <!-- The Modal -->
                 <div class="modal fade" id="cekout<?=$idb;?>" role="dialog">
                      ...
                      <div class="modal-body">
                        <form action="#" method="post">
                          ...
                          <input type="hidden" class="form-control" name="id_brng" value="<?php echo $row['id_brng'] ?>" >
                            ...
                            <div class="form-group has-feedback">
                              <textarea type="text" name="deskripsi" rows="4" class="form-control" placeholder="Ket.." required></textarea>
                              <span class="glyphicon glyphicon-edit form-control-feedback"></span>
                            </div>
                           </div> 
                           <!-- Modal footer -->
                           <div class="modal-footer">
                          <button type="submit" name="brngkeluar" class="btn btn-primary">Cek Out</button> 
                        </div> 
                        </form>
                    </div>
                  </div>
                      ...
                      <div class="modal-body">
                        <form action="#" method="post">
                          ...
                          <input type="hidden" class="form-control" name="id_brng" value="<?php echo $row['id_brng'] ?>" >
                           ...
                           <!-- Modal footer -->
                           <div class="modal-footer">
                          <button type="submit" name="brngmasuk" class="btn btn-success">Add</button>
                        </div>
                        </form>
                    </div>
                  </div>

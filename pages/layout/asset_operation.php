              ...
              <div class="col-12">
                ...
                <tr>
                 ...
                 <?php
                    ...
                    where kategory_b in ('PC','UPS','Laptop','Operation') and asset in ('Asset')  order by id desc ");
                    $no=0; 
                    $no++;
                ...
                <tr>
                  ...
                  <td width='6%'>
                     ...
                     <a href="../prosess/serah_terima.php?id=<?=$ida;?>" target="_blank"><i class="fa fa-print" style="color:red;"> </i></a>
                    </div>
                  </td>
                 ...
                 <div class="modal fade" id="delete<?=$ida;?>" role="dialog">
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <input type="hidden" name="penerima" value="<?php echo $row3['nik'] ?>">
                          <div class="modal-footer">

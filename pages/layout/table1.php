        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="view_operation.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Operation</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="view_operation.php">View Devide</a></li>
            ...
            <div class="row">
              ...
              <table id="example2" class="table table-bordered table-striped">
                ...
                <?php
                    ...
                    left join tb_lokasi l on l.id_lokasi=s.id_lokasi where kategory_b in ('PC','UPS','Laptop','Operation') and asset in ('Asset','Low Value Asset') and s.id_brng='$idba' order by tanggal desc ;"); 
                    $no=0;
                    $no++;
                          ...
                          <img src="../../logo.jpg" class="pull-right" style="height:38px; width:95px;">
                              ...
                              <div class="modal-body">
                                  <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <button type="submit" class="btn btn-danger" name="devicerusakoperation" onclick="return confirm('Anda Yakin, Barang ini Rusak')">Rusak</button> 
                                    <button type="submit" class="btn btn-primary" name="updatebrngassetmasukoperation">Update</button>                               
                                    </div>
                                  </form>
                              </div>
                         </div>
                 ...
                 <div class="modal fade" id="delete<?=$idm;?>" role="dialog">
                      <div class="modal-dialog">\
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                          <button type="submit" class="btn btn-danger" name="hapusdataassetmasukoperation">delete</button>
                          </div>
                          </form >
                        </div>
                      </div>
                              ...
                              <div class="modal-body">
                                  <form method="post" role="form" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select name="id_kar" class="form-control select2" style="width: 100%;" required>
                                        <option></option>
                                        <?php                                    
                                    ...
                                    <div class="form-group">
                                      <label>No Po</label>
                                      <input type="text" class="form-control" name="no_po" value="<?=$no_po_m;?>" disabled>
                                      <input type="hidden" class="form-control" name="no_po" value="<?=$no_po_m;?>" >
                                    </div>
                                    <div class="form-group">
                                      <label>No Asset</label>
                                      <input type="text" class="form-control" name="no_asset" value="<?=$no_asset_m;?>" disabled>
                                    ...
                                    <div class="form-group"> 
                                      ...
                                      <textarea class="form-control" rows="4" name="ket" placeholder="- Type Monitor :  -Ups :  - Windows: " required></textarea>
                                    </div>
                                    <div class="form-group">
                                      <label>Lokasi</label>
                                      <select name="lokasi" class="form-control" required>
                                        <option>  </option>
                                        <?php                
                                          $query3=mysqli_query($koneksi, "SELECT * FROM tb_lokasi2" ) or die (mysqli_error($koneksi));
                                          while($data3=mysqli_fetch_array($query3)){
                                          echo "<option value=$data3[lokasi]> $data3[lokasi] </option>";
                                          }
                                        ?>
                                      </select>
                                    </div>
                                    ...
                                    <input type="hidden" name="idb" value="<?=$idb;?>">
                                    <input type="hidden" name="idm" value="<?=$idm;?>">
                                    <input type="hidden" name="penyerah" value="<?php echo $row3['nik'] ?>">
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-default pull-right pading" data-dismiss="modal">Close</button>
                                      <button type="submit" class="btn btn-primary pull-right pading" name="insertassetoperation">Submit</button>
                                    </div>
                                  </form>
                              </div>
                        </div> 
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="#" method="post">
                                ...
                                <!-- Modal footer -->
                                <div class="modal-footer">
                                <button type="submit" name="brngassetmasukoperation" class="btn btn-success">Add</button>
                              </div>
                              </form>
                          </div>
                        </div>

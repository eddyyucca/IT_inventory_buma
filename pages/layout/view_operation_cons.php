...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" action="view_operation_cons.php" method="get">
  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="zoom:85%;">
        ...
        <div class="row  mb-2">
          <div class="col-sm-12">
                <a href="view_operation.php" class="btn btn-primary btn-sm" style="color:black;"> <i class="fa fa-book"  style="color:white;"></i><b style="font-zise:8px; color:white;"> Device</b></a>
          </div>
        </div>
        <?php  
                ...
                if($_GET['pesan1']=="berhasil"){
                     ...
                     <?php 
                      if(isset($_GET['pesan3'])){
                       ...
                       echo "<div class='alert' style='background:#f5c77e; color:black ;' ><b>!!!</b> S/N yang anda masukan already</div>";
                         }
                    }?> <?php 
                    if(isset($_GET['cari'])){
                      $cari = $_GET['cari'];
               ...
               if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $query=mysqli_query($koneksi, "SELECT  * FROM stock s left join tb_lokasi l on l.id_lokasi=s.id_lokasi where asset in('Consumable') and kategory_b in ('PC','UPS','Laptop','Operation') and nma_brng like '%".$cari."%'");		
              }else{
                  $query=mysqli_query($koneksi, "SELECT  * FROM stock s left join tb_lokasi l on l.id_lokasi=s.id_lokasi where asset in('Consumable') and kategory_b in ('PC','UPS','Laptop','Operation') order by kategory_b DESC "); 
              }
               ...
               <div class="col-md-2">
                    ...
                    <div class="card">
                        <a href="../uploads/<?php echo$row['image']; ?>" target="_blank">
                          <center><img  src="../uploads/<?php echo$row['image']; ?>" alt="User profile picture" style="height: 240px; width:260px; "></center>
                        </a>
                        ...
                        <div class="card-body">
                          ...
                          <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#cekout<?=$idb;?>"><i class="fa  fa-book"></i> Get</a>
                ...
                <!-- The Modal -->
                <div class="modal fade" id="cekout<?=$idb;?>">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="#" method="post">
                          ...
                          <button type="submit" name="brngkeluar1" class="btn btn-primary">Cek Out</button>
                        </div>
                        </form>
                    </div> 
                  </div>
                      ...
                      <div class="modal-body">
                        <form action="#" method="post">
                          ...
                          <input type="hidden" class="form-control" name="id_brng" value="<?php echo $row['id_brng'] ?>" >
                           ...
                           <!-- Modal footer -->
                           <div class="modal-footer">
                          <button type="submit" name="brngmasuk1" class="btn btn-success">Add</button>
                        </div>
                        </form>
                    </div>
                  </div>

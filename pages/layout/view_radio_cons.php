...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" action="view_radio_cons.php" method="get">
  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="zoom:85%;">
        ...
        <div class="row  mb-2">
          <div class="col-sm-12">
                <a href="view_radio.php" class="btn btn-primary btn-sm" style="color:black;"> <i class="fa fa-book"  style="color:white;"></i><b style="font-zise:8px; color:white;"> Device</b></a>
          </div>
        </div>
        <?php  
               ...
               if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $query=mysqli_query($koneksi, "SELECT  * FROM stock s left join tb_lokasi l on l.id_lokasi=s.id_lokasi where kategory_b in ('Radio Rig','Radio') and asset='Consumable' and nma_brng like '%".$cari."%'");		
              }else{
                $query=mysqli_query($koneksi, "SELECT  * FROM stock s left join tb_lokasi l on l.id_lokasi=s.id_lokasi where kategory_b in ('Radio Rig','Radio') and asset='Consumable'  order by id_brng DESC  ");
              }
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="#" method="post">
                          ...
                          <button type="submit" name="brngkeluar2" class="btn btn-primary">Cek Out</button>
                        </div>
                        </form>
                    </div>
                  </div>

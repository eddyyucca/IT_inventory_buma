<?php
require '../koneksi.php'; session_start();
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="#" class="navbar-brand">
        ...
        <span class="brand-text font-weight-light">Hi, <?php echo $row3['nama'] ?></span>
      </a>
              ...
              <?php 
                ...
                <div class="col">
                    <div class="card border-right border-primary rounded-0">
                        <div class="card-body" >
                            <div class="col-12 text-truncate"><a href="view_page.php?page=<?php echo urlencode($page) ?>" title="<?php echo $page ?>" class=""><b style="color:black;"><?php echo $page ?></b></a></div>
                            <div class="w-100 d-flex justify-content-end">
                                <a href="manage_page.php?page=<?php echo urlencode($page)?>" class="btn btn-sm rounded-0 btn-primary me-2" ><i class="far fa-edit nav-icon"></i> Edit</a>
                                &nbsp;&nbsp;
                                <a href="delete_page.php?page=<?php echo urlencode($page)?>" class="btn btn-sm rounded-0 btn-danger delete_data"><i class="fa fa-trash nav-icon"></i> Delete</a>
                            </div>
                        </div>
                    </div>
                </div>

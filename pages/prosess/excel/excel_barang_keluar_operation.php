...
header("Content-Disposition: attachment; filename=Comsumable Operation.xls")
                ...
                <tr>
                  ...
                  <th>Tgl Update</th>
                     ...
                     $query=mysqli_query($koneksi, "SELECT *
                      FROM tb_keluar k
                    join stock s on s.id_brng=k.id_brng_k where kategory_b in ('PC','UPS','Laptop','Operation') and asset in('Consumable')

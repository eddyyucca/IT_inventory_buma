...
header("Content-Disposition: attachment; filename=Data Consumable_IT.xls")
...
<table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Aksi</th>
                    ...
                    left join tb_lokasi l on l.id_lokasi=s.id_lokasi where kategory_b in ('Consumable') order by id_masuk desc  ");
                    $no=0;
                    $no++;

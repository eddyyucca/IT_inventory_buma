...
<table style="width:100%; ">
   <tr style="height:50px;  border:none;">
    ...
    <td colspan="4" style="height:50px;  border:none;"><center><b style="font-size:25px;">PENGEMBALIAN BARANG</b></center></td>
  ...
  <tr style="font-size:15px;">
    ...
    <td colspan="2"><?php echo $row1['no_asset_r'] ?></td>
    <td>No. Urut</td>
  ...
  <tr style="font-size:12px;">
    ...
    <td><?php echo $row['no_po'] ?></td>
     <td><?php echo $row['no_asset_r'] ?></td>
    <td><?php echo $row['sn_s'] ?></td>
    <td><?php echo $row['ket'] ?></td>
  </tr>
<?php $no++; } ?>
  <tr style="font-size:10px;">
     <td rowspan="5" colspan="4" style="vertical-align : top; border:none;" ><b >Catatan :</b><br/> PENGEMBALIAN <?php echo $row1['kategory_b'] ?> <?php echo $row1['nma_brng'] ?> SN : <?php echo $row1['sn_s'] ?>  | Kod.SAP : <?php echo $row1['no_asset_r'] ?><BR/> PIC : <?php echo $row1['nama'] ?></td>
  ...
  <tr width='50%'  height="80px"  style="font-size:12px; vertical-align : top;"> 
   ...
   <tr style="font-size:12px; text-align: center;"> 
    <td colspan="3" width='50%'> <?php echo $row1['nama'] ?> / <?php echo $row1['nik'] ?> </td>
     <td colspan="3"> IT IPR : <?php echo $row3['nama'] ?> / <?php echo $row3['nik'] ?></td>
  </tr>
   <tr style="font-size:12px;"> 
    <td colspan="6"></td>
  </tr>
